package org.example.analyzer.javaparser.intra;
...
import org.example.analyzer.javaparser.FieldRefExtractor;
import org.example.analyzer.javaparser.LocalAliasResolver;
import org.example.analyzer.javaparser.MappingExtractor;
 ...
 */
public class EqualsMappingExtractor implements MappingExtractor {
    ...
    public List<FieldMapping> extract(CompilationUnit cu, String fileName,
        ...
        new VoidVisitorAdapter<Map<String, Expression>>() {
            ...
            public void visit(MethodCallExpr n, Map<String, Expression> aliasMap) {
                ...
                allNorm.addAll(fieldRefExtractor.extractNormalization(caller));
                allNorm.addAll(fieldRefExtractor.extractNormalization(argument));

                result.add(new FieldMapping(leftSide, rightSide, type, MappingMode.READ_PREDICATE,
                        rawExpr, location, allNorm));
            }
